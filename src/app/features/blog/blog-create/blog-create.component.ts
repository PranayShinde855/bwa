...
import { getByIdBlogRequest } from '../../../models/BlogMoels/getByIdBlogRequest';
import { BlogUpdateRequest } from '../../../models/BlogMoels/BlogUpdateRequest';
import { BlogAddRequest } from '../../../models/BlogMoels/BlogAddRequest';
    ...
    if (this.blogForm.valid) {
      ...
      if (this.id) {
        let updateRequest: BlogUpdateRequest = {
          id: this.id,
          categoryId: this.blogForm.get('type')?.value,
